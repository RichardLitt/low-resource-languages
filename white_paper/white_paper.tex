...
\abstract{
We present an ontology of open source code that can be used by low-resource language
communities to build digital resources. Our ontology is also useful to software developers
