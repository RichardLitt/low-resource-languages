...
# Generic Repositories
  ...
  * [FieldDB](https://github.com/OpenSourceFieldlinguistics/FieldDB/milestones?direction=desc&sort=due_date&state=closed) An offline/online field database which adapts to its user's terminology and I-Language. For field linguist users its called http://LingSync.org
  ...
  * [LingSync.org](https://github.com/OpenSourceFieldlinguistics/FieldDB/milestones?direction=desc&sort=due_date&state=closed) A Free Tool for Creating and Maintaining a Shared Database For Communities, Linguists and Language Learners http://LingSync.org
